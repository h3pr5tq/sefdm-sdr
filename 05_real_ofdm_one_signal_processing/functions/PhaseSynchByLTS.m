...
% + ДАЖЕ ЕСЛИ НЕ ПРОМАХНУЛИСЬ, ТО ОСТАЁТСЯ НЕСКОМПНСИРОВАННЫЙ ФАЗОВЫЙ НАБЕГ. ОН ТЕМ БОЛЬШЕ ЧЕМ ДОЛЬШЕ OFDM-СИМВОЛ.
% С чем он связан пока что хз. МБ остаточная частотная отстройка?
%
