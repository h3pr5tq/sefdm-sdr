...
# Title: Tag Test
# Generated: Sat Apr  7 13:03:02 2018
##################################################
...
class tag_test(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_vector_source_x_1 = blocks.vector_source_f(in_data, False, 1, [])
        ...
        self.connect((self.learn_tag_test_0, 0), (self.blocks_tagged_stream_to_pdu_0, 0))    
    ...
    def set_in_data(self, in_data):
        ...
        self.blocks_vector_source_x_1.set_data(self.in_data, [])
