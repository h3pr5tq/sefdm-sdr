...
# Title: Ieee 802 11A Preamble Detection Test
# Generated: Sun Apr  8 19:36:31 2018
##################################################
...
class ieee_802_11a_preamble_detection_Test(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Ieee 802 11A Preamble Detection Test")
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Ieee 802 11A Preamble Detection Test")
        try:
        ...
        self.settings = Qt.QSettings("GNU Radio", "ieee_802_11a_preamble_detection_Test")
        ...
        # Blocks
        ##################################################
        self.sefdm_ieee_802_11a_preamble_detection_0 = sefdm.ieee_802_11a_preamble_detection(144, 16, 0.7, True, 0, packet_len_with_margin_tag_key, packet_len, 150)
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, '/home/ivan/Yandex.Disk/documents/Practick/sdr/Signals/RxBaseband_ComplexFloat32_bin/rx_randi_20ofdm_20000pckt_16.dat', False)
...
def main(top_block_cls=ieee_802_11a_preamble_detection_Test, options=None):
